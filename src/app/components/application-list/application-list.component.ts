...
export class ApplicationListComponent implements OnInit {
  ...
  public arrayApplications: Application[] = [
    ...
    { name: 'Chrono_VanillaJS', img: '../../assets/img/Chrono_Angular.png', link: 'https://sad-nobel-a89988.netlify.app/', usedTechnos: ['HTML', 'CSS', 'JavaScript']}
  ];
